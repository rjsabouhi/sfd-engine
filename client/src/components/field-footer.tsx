...
export function StructuralFieldFooter({ probeData, basinMap, isHovering }: StructuralFieldFooterProps) {
  ...
  return (
    <div 
      className="flex items-center gap-4 px-4 py-3 text-[11px] font-mono border-t border-white/5 overflow-x-auto shrink-0"
      style={{ backgroundColor: 'rgba(8, 10, 14, 0.9)', height: '52px', minHeight: '52px' }}
