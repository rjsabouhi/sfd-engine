...
export default function SimulationPage() {
  ...
  const [derivedType, setDerivedType] = useState<"curvature" | "tension" | "coupling" | "variance" | "basins" | "gradientFlow" | "criticality" | "hysteresis" | "constraintSkeleton" | "stabilityField" | "gradientFlowLines">("curvature");
  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      <OnboardingModal />
      <header className="relative flex items-center justify-center px-3 py-2 border-b border-border bg-card/50">
