    ...
    return (
      <div className="relative w-screen overflow-hidden bg-black" style={{ height: 'var(--app-height, 100dvh)' }}>
        ...
        <div 
          ...
          style={{
            top: mobileActiveTab ? '6px' : '64px', // 64px clears header tightly, 6px when header slides away
            left: '6%',
            right: '6%',
            bottom: `calc(${82 + panelOffset}px + env(safe-area-inset-bottom, 0px))`, // 82px for bottom control strip tightly + panel offset + safe area
        ...
        {mobileActiveTab === "regimes" && (
          <div className="absolute left-3 right-3 z-40" style={{ bottom: 'calc(82px + env(safe-area-inset-bottom))' }}>
