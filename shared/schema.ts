...
export const simulationParametersSchema = z.object({
  ...
  mode: z.enum(["standard", "quasicrystal", "criticality", "fractal", "soliton", "cosmicweb", "mg1", "mg2", "mg3", "mg4"]).default("standard"),
});
...
export const structuralPresets: Record<string, Partial<SimulationParameters>> = {
  ...
  "soliton-entity": {
    ...
    curvatureGain: 4.0,
    couplingWeight: 0.85,
    attractorStrength: 6.0,
    redistributionRate: 0.08,
    wK: 1.5,
    wT: 0.6,
    wC: 2.5,
    wA: 4.0,
  ...
  "mg-spiral-emergence": {
    ...
    couplingRadius: 0.8,
    couplingWeight: 0.36,
    attractorStrength: 4.1,
    redistributionRate: 0.12,
    wK: 1.8,
    wT: 1.2,
    wC: 1.5,
    wA: 2.05,
  ...
  "mg-patch-formation": {
    ...
    couplingRadius: 1.5,
    couplingWeight: 0.61,
    attractorStrength: 2.7,
    redistributionRate: 0.16,
    wK: 1.05,
    wT: 2.9,
    wC: 1.65,
    wA: 1.35,
